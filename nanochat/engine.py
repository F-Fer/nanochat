...
class KVCache:
    ...
    def prefill(self, other):
        ...
        other_layers, other_kv, other_batch, other_heads, other_seq, other_head_dim = self.kv_shape
...
class Engine:
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        # Get the special tokens we need to coordinate teh tool use state machine
        def get_special(s):
            self.tokenizer.encode_special(s)
